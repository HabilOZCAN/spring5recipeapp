...
//        Yummy Guac
        ...
        guacRecipe.getIngredients().add(new Ingredient("ripe avacados", new BigDecimal(2), eachUom));
        ...
        guacRecipe.getIngredients().add(new Ingredient("Minced Onion", new BigDecimal(2), tableSpoonUom));
        ...
        guacRecipe.getIngredients().add(new Ingredient("freshy pepper", new BigDecimal(2), dashUom));
        guacRecipe.getIngredients().add(new Ingredient("Ripe Tomato", new BigDecimal(".5"), eachUom));
...
//        Yummy Tacos
        ...
        tacoRecipe.getIngredients().add(new Ingredient("Clove of Garlic", new BigDecimal(1), eachUom));
        tacoRecipe.getIngredients().add(new Ingredient("Finely grated orange", new BigDecimal(1), tableSpoonUom));
        tacoRecipe.getIngredients().add(new Ingredient("Fresh-squeezed Orange", new BigDecimal(3), tableSpoonUom));
        tacoRecipe.getIngredients().add(new Ingredient("Olive Oil", new BigDecimal(2), tableSpoonUom));
        tacoRecipe.getIngredients().add(new Ingredient("Boneless chicken", new BigDecimal(4), tableSpoonUom));
        tacoRecipe.getIngredients().add(new Ingredient("Small Corn tortillas", new BigDecimal(8), eachUom));
        tacoRecipe.getIngredients().add(new Ingredient("Packed baby arugula", new BigDecimal(3), cupsUom));
        tacoRecipe.getIngredients().add(new Ingredient("Medium riped Avocados", new BigDecimal(2), eachUom));
        tacoRecipe.getIngredients().add(new Ingredient("Radishes", new BigDecimal(4), eachUom));
        tacoRecipe.getIngredients().add(new Ingredient("Cherry", new BigDecimal(".5"), pintUom));
        tacoRecipe.getIngredients().add(new Ingredient("Red onion", new BigDecimal(".25"), eachUom));
        tacoRecipe.getIngredients().add(new Ingredient("Roughly chopped cilantro", new BigDecimal(4), eachUom));
        tacoRecipe.getIngredients().add(new Ingredient("Cup sour cream", new BigDecimal(4), cupsUom));
        tacoRecipe.getIngredients().add(new Ingredient("Lime", new BigDecimal(4), eachUom));
